...
<!-- End webpage header html-->
    ...
    <main>
        ...
        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data">
            ...
            <label for="userGender">Role:</label><br>
            <select id="userGender" name="userGender">
                <option value="Lecturer" <?php if ($row['userGender'] === 'Lecturer') echo 'selected'; ?>>Lecturer</option>
                <option value="Student" <?php if ($row['userGender'] === 'Student') echo 'selected'; ?>>Student</option>
            </select><br>
