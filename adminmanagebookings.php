...
<a href="home.php" style="margin-top: 180px;"><img src="CSLogoNoBackground.png" height="100" width="150" style="background-color: black;"></a>
...
<main>
   ...
   <form action="delete_booking.php" method="post">
    <table>
        ...
        <tbody>
            <?php
            // Fetch bookings and resource information
            $sql = "SELECT b.bookingID, u.userFirstName, u.userLastName, u.userPhone, u.userEmail, b.resourceID, b.bookingDate, b.bookingStartTime, b.bookingEndTime, b.bookingDuration, c.resourceType, c.resourceName
                    FROM booking b 
            ...
            if ($result->num_rows === 0) {
                ...
                // Display bookings and resource information in table rows
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<td>" . htmlspecialchars($row["resourceType"]) . "</td>";
