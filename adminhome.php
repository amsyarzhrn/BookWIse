...
// Query to get the count of Resource
$sqlCountResources = "SELECT COUNT(*) AS totalResources FROM resourceinfo";
$resultCountResources = $conn->query($sqlCountResources);
$countResources = $resultCountResources->fetch_assoc()["totalResources"];
...
category
</span>  Manage Booking</a>


  <a href="adminmanageresource.php"><span class="material-symbols-outlined">
sports_soccer
...
<a href="home.php" style="margin-top: 195px;"><img src="CSLogoNoBackground.png" height="100" width="150" style="background-color: black;"></a>
...
<main>
        ...
        <div class="dash-content">
                ...
                <div class="boxes">
                    <div class="box box1">
                        ...
                        <span class="texttitle">Total Resources :</span><br><br>
                        <span class="courtCount"><?php echo $countResources; ?></span> 
                      </a>
                    </div>
    ...
    <table>
        ...
        <tbody>
            <?php
            // Fetch today's bookings, resource, and user information
            $today = date("Y-m-d"); // Get today's date
            $sql = "SELECT b.bookingID, b.bookingDate, b.bookingStartTime, b.bookingEndTime, b.bookingDuration, b.resourceID, c.resourceName, u.userFirstName, u.userPhone, u.userEmail 
                    FROM booking b 
                    INNER JOIN resourceinfo c ON b.resourceID = c.resourceID 
            ...
            if ($result->num_rows === 0) {
                ...
                // Display bookings, Resource, and user information in table rows
