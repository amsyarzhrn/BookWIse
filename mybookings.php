...
<head>
    ...
    <title>My Resource Bookings</title>
...
<!-- End webpage header html-->
    ...
    <main>
          ...
          <form action="userdelete_bookings.php" method="post">
            <table class="mybookings">
                ...
                <tbody>
                    ...
                    $username = $_SESSION['username'];
                    $sql = "SELECT b.bookingID, c.resourceID, c.resourceName,  b.bookingDate, b.bookingStartTime, b.bookingEndTime, b.bookingDuration 
                    FROM booking b 
                    ...
                    if ($result->num_rows === 0) {
                        echo "<tr><td colspan='9'>No recorded bookings, <a href='bookresource.php'>Let's Book Now!</a></td></tr>";
                    } else {
        ...
        <p style="margin-top: 20px; font-size: 16px; ">Please show booking ID at the admin upon pickup of resource at the admin office. Thank You!</p><br><br>
    </main>
</body>
</html>
