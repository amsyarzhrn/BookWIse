...
<title>Admin Manage Resource</title>
...
<main>
        ...
        <br>
        <h1>Admin Manage Resource</h1><br>
       
       <div class="ListTable">
       <form action="admindeleteresource.php" method="post">
        <table>
            <thead>
                <tr>
                    <th>Select</th>
            ...
            <tbody>
                ...
                // Display Resource data in table rows
                while ($row = $result->fetch_assoc()) {
                    echo "<tr>";
                    echo "<td><input type='radio' name='resource_ids[]' value='" . $row['resourceID'] . "'></td>";
        ...
        <br>
        <input type="submit" name="edit" value="Edit Selected Resource">
        <input type="submit" name="delete" value="Delete Selected Resource">
        <input type="submit" name="add" value="Add New Resource">
    </form>
